fetch('https://randomuser.me/api/')
    ...
    .then(mydata => {
        mydata.results.map(function (val) {
            ...
            <section class="col-12 d-flex flex-wrap justify-content-center align-items-center">
            ...
            <div class="col-10 p-2 mt-2 d-flex justify-content-between align-items-center">
            <span>firstName : ${val.name.first}</span>
            <span>lastName : ${val.name.last}</span>
            <span>age : ${val.dob.age}</span>
            </div>
            <div class="col-11 mt-2 p-2 d-flex justify-content-between align-items-center">
            ...
            <button onclick="reload()" class="rounded-2 mt-3 p-2 border-0">GET RANDOM USER </button>
            </section>
